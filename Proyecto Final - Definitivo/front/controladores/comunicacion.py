...
class Comunicacion():
    ...
    def __init__(self, ventanaPrincipal):
        self.url1 =  'http://127.0.0.1:8000/v1/cliente'
    ...
    def consultar_cedula(self, cedula):
        ...
        data = resultado.json()  # Asumiendo que el servidor retorna JSON

        # Asumiendo que el servidor retorna una lista de clientes, y si no hay clientes, la lista está vacía
